        ...
        <nav class="navbar ownmenu navbar-expand-lg">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="nav">
                    ...
                    <!-- MEGA MENU -->
                    <li class="dropdown megamenu"> <a href="#." class="dropdown-toggle" data-toggle="dropdown">Mega
                            Store</a>
                        <div class="dropdown-menu">
                            ...
                            <!-- MEga Menu Elements -->
                            <div class="mega-menu-elements"> <img src="images/nav-img.png" alt=""> <a href="#." class="btn btn-inverse">Shop
                                    Now</a> </div>
                        </div>
                    </li>
                    <li> <a href="contact.html"> contact</a> </li>
